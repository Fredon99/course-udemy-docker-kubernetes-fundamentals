...
> Parte do monorepo [Udemy — Docker & Kubernetes](../README.md). Para uma visão integrada Docker + K8s, veja [`fundamentals/`](../fundamentals/).
...
Índice completo em **[docs/README.md](docs/)**.
